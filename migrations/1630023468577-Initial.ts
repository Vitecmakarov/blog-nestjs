...
export class Initial1630023468577 implements MigrationInterface {
  name = 'Initial1630023468577';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`nestjs_blog\`.\`categories\` (\`id\` char(36) NOT NULL, \`title\` varchar(100) NOT NULL, \`mpath\` varchar(255) NULL DEFAULT '', \`user_id\` char(36) NULL, \`parentId\` char(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`nestjs_blog\`.\`categories\` ADD CONSTRAINT \`FK_9a6f051e66982b5f0318981bcaa\` FOREIGN KEY (\`parentId\`) REFERENCES \`nestjs_blog\`.\`categories\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`nestjs_blog\`.\`posts_categories\` ADD CONSTRAINT \`FK_3e42f8cab05b4221f7dba178a15\` FOREIGN KEY (\`category\`) REFERENCES \`nestjs_blog\`.\`categories\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`nestjs_blog\`.\`categories\` DROP FOREIGN KEY \`FK_9a6f051e66982b5f0318981bcaa\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP INDEX \`REL_ca0ed9873891665fff3d9d39cc\` ON \`nestjs_blog\`.\`images\``);
    await queryRunner.query(`DROP INDEX \`REL_decdf86f650fb765dac7bd091a\` ON \`nestjs_blog\`.\`images\``);
